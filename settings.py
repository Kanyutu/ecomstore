...
SITE_NAME = 'Data Lava Timebank'
META_KEYWORDS = 'datalava, timebanking, data, community sense'
META_DESCRIPTION = 'timebanking '
...
DATABASE_NAME = 'fm'             # Or path to database file if using sqlite3.
